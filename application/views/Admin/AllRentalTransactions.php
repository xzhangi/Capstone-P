                            ...
                            <table width="100%" class="table table-striped" id="dataTables-example">
                                <thead>
                                    <tr>
										...
										<tr>
										<td><?php echo ($i+1); ?></td>
										<td align="center"><?php echo $translist[$i]->Rent_From_Date; ?></td>
										<td align="center"><?php echo $translist[$i]->Rent_To_Date; ?></td>
										<td align="center"><?php echo $translist[$i]->Rented_By; ?></td>
										<td align="center"><?php echo $translist[$i]->Rental_Type; ?></td>
										<td align="center"><?php echo $translist[$i]->Creation_Date; ?></td>
										<?php if($translist[$i]->Is_Active) { ?>
										<td align="center">Yes</td>
										<?php } else { ?>
										<td align="center">No</td>
										<?php } ?>
										<td align="center"><?php echo $translist[$i]->Points_Obtained; ?></td>
										</tr>
										<?php } ?>
