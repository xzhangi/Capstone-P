...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Locker Size</h1>              
					</div>
					</div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                        <th>Locker Size ID</th>
										<th>Name</th>
                                        </tr>
										<tbody>
										<tr class="danger">

										<?php for ($i = 0; $i < count($lockersizelist); $i++) { ?>
										<tr class="danger">
										<td><?php echo $lockersizelist[$i]->Locker_Size_ID; ?></td>
										<td><?php echo $lockersizelist[$i]->Name; ?></td></tr>
										<?php } ?>
										</tr>
										</tbody>
                                    </thead>
