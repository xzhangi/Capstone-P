            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
						<li><a href="<?php echo base_url();?>AdminHome/do_logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                <!-- /.dropdown -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>adminlogin"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url() ?>accountmanagement"><i class="fa fa-table fa-fw"></i>Account Management</a>
                        </li>
                        <li>
								...
								<div class="row">
									<div class="col-lg-6">
										...
										<label>Admin Number (if applicable)</label>
											<input name="username" class="form-control" value="<?php echo $Userdata['Username'] ?>" type="text">
										</div>
										<div class="form-group">
										<label>Email</label>
