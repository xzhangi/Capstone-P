          ...
          <div class="row">
            <div class="well well-trans">
              ...
              <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.1s">
                ...
                <input type="submit" value="Confirm topup" onclick="return confirm('Proceed with top up?');" class="btn btn-primary btn-block btn-lg" form="topupform" style="margin-top: 15px;">
